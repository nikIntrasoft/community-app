                ...
                case "glimApprove":
                    ...
                    resourceFactory.glimLoanTemplate.get({glimId: scope.glimId}, function (data) {
                        ...
                        for(i=0;i<scope.glimAccounts.length;i++)
                        {
                          ...
                          /*  resourceFactory.loanTemplateResource.get({loanId: data[i].childLoanId, templateType: 'approval'}, function (data1) {

                                temp.approvedLoanAmount=data1.approvalAmount;


                                scope.totalLoanAmount+=parseFloat(data1.approvalAmount);
